            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="banner-content">
                        <h1 class="banner-title wow pixFadeUp font-banner-title" data-wow-delay="0.3s">
                            <span>Forstaff </span> aplikasi <br />
                            <span>Human Resource Terbaik</span> <br />
                            untuk Perusahaan Anda
                        </h1>
                        <p class="description wow pixFadeUp" data-wow-delay="0.5s">
                            Forstaff hadir sebagai solusi manajemen HRD perusahaan<br />yang
                            menghasilkan KPI untuk menunjang keputusan<br />strategis
                            perusahaan anda.
                        </p>
                        <a href="https://www.forstaff.id/tentang" class="pxs-btn banner-btn wow pixFadeUp"
                            data-wow-delay="0.6s">Dapatkan Informasi Lainnya</a>
                ...
                <div class="col-lg-6">
                    <div class="promo-mockup wow pixFadeLeft">
                        <img src="https://www.forstaff.id/assets/media/banner/home.png"
                            alt="Desktop dan mobile view" title="Desktop dan mobile view" width="1000"
                            height="539" />
                    </div>
                </div>
            </div>
        ...
        <div class="row">
                ...
                <div class="pixsass-icon-box-wrapper style-one wow pixFadeLeft" data-wow-delay="0.3s">
                    <div class="iapp-icon-box-icon text-center">
                        <img src="https://www.forstaff.id/assets/media/feature/sistem-terintegrasi.png"
                            alt="Sistem Terintegrasi" title="Sistem Terintegrasi" width="140"
                            height="139" />
                    </div>
            ...
            <div class="col-md-4 padding-left-right-25">
                <div class="pixsass-icon-box-wrapper style-one wow pixFadeLeft" data-wow-delay="0.5s">
                    <div class="iapp-icon-box-icon text-center">
                        <img src="https://www.forstaff.id/assets/media/feature/mobile-apps.png"
                            alt="Mobile Apps" title="Mobile Apps" width="140" height="139" />
                    </div>
                    <div class="pixsass-icon-box-content">
                        <h3 class="pixsass-icon-box-title text-center margin-bottom30">
                ...
                <div class="pixsass-icon-box-wrapper style-one wow pixFadeLeft" data-wow-delay="0.7s">
                    <div class="iapp-icon-box-icon text-center">
                        <img src="https://www.forstaff.id/assets/media/feature/request-approval.png"
                            alt="Request and Approval" title="Request and Approval" width="140"
                            height="139" />
                    </div>
                    <div class="pixsass-icon-box-content">
                        <h3 class="pixsass-icon-box-title text-center margin-bottom30">
...
<section class="editor-design margin-bottom30">
        ...
        <div class="row">
            <div class="editure-feature-image wow pixFadeRight">
                <div class="image-one" data-parallax='{"x" : 30}'>
                    <img src="https://www.forstaff.id/assets/media/feature/view-mobile.png"
                        class="wow pixFadeRight" data-wow-delay="0.3s" alt="Mobile View" title="Mobile View"
                        width="720" height="594" />
                </div>
                <div class="image-two">
    ...
    <div class="shape-bg">
        <img src="https://www.forstaff.id/assets/media/background/shape_bg.png" class="wow fadeInLeft"
            alt="shape-bg" title="shape-bg" width="1448" height="1137" />
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 padding-left-right-25">
                <div class="pixsass-icon-box-wrapper style-two wow pixFadeRight" data-wow-delay="0.5s">
                    <div class="iapp-icon-box-icon text-center">
                        <img src="https://www.forstaff.id/assets/media/feature/staff-apps.png"
                            alt="Staff Apps" title="Staff Apps" width="100" height="100" />
                    </div>
                    <div class="pixsass-icon-box-content">
                        <h3 class="pixsass-icon-box-title text-center">
                            <a href="#">Staff Apps</a>
                ...
                <div class="pixsass-icon-box-wrapper style-two wow pixFadeRight" data-wow-delay="0.6s">
                    <div class="iapp-icon-box-icon text-center">
                        <img src="https://www.forstaff.id/assets/media/feature/request-n-approval.png"
                            alt="Request and Approval" title="Request and Approval" width="100"
                            height="100" />
                    </div>
                    <div class="pixsass-icon-box-content">
                        <h3 class="pixsass-icon-box-title text-center">
            ...
            <div class="col-lg-4 col-md-6 padding-left-right-25">
                <div class="pixsass-icon-box-wrapper style-two wow pixFadeRight" data-wow-delay="0.7s">
                    <div class="iapp-icon-box-icon text-center">
                        <img src="https://www.forstaff.id/assets/media/feature/kpi.png" alt="KPI"
                            title="KPI" width="100" height="100" />
                    </div>
                    <div class="pixsass-icon-box-content">
                        <h3 class="pixsass-icon-box-title text-center">
                            <a href="#">KPI</a>
